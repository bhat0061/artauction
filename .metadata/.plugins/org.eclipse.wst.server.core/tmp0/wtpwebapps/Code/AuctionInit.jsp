    ...
    %>
    	...
    	ResourceBundle resource = ResourceBundle.getBundle(lang);
        	...
        	"<div class=\"col-md-3 col-sm-6 hero-feature\">" +
        		"<div class=\"thumbnail\">"+
	        		"<a class=\"btn btn-default\" aria-label=\"Left Align\" style=\"width:250px;height:247px;background-color:#5cb85c;\" href=\"createEnglishAuction.jsp\"><br><br><br><br><br>"+resource.getString("createAuction")+"</a>" + 
				"</div>" +
			"</div>");
        }
        %>